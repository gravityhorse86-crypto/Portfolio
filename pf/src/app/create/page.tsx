      ...
      <div className="mx-auto w-full max-w-md md:max-w-2xl bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8">
        ...
        <div className="mb-8 border-b border-slate-100 pb-4">
          <ul className="flex gap-6 text-sm font-medium text-slate-500">
            <li className="cursor-pointer hover:text-sky-600 transition-colors">フィルター</li>
            <li className="cursor-pointer hover:text-sky-600 transition-colors">並び替え</li>
          </ul>
        </div>
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* 暗唱文入力 */}
          <div>
            <label htmlFor="object" className="mb-2 block text-sm font-semibold text-slate-700">暗唱したい文</label>
            <input 
              type="text" 
              name="object" 
          ...
          {/* 訳入力 */}
          <div>
            <label htmlFor="translation" className="mb-2 block text-sm font-semibold text-slate-700">日本語訳</label>
            <input 
              type="text" 
              name="translation" 
