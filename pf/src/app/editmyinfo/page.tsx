    ...
    <div className="min-h-screen bg-slate-50 p-4 md:p-8">
      <div className="mx-auto w-full max-w-md md:max-w-2xl bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div>
            <label className="mb-2 block text-sm font-semibold text-slate-700">ID</label>
            <input 
              type="text" 
              name="id" 
          ...
          {/* ユーザー名 */}
          <div>
            <label className="mb-2 block text-sm font-semibold text-slate-700">ユーザー名</label>
            <input 
              type="text" 
              name="username" 
          ...
          {/* メールアドレス */}
          <div>
            <label className="mb-2 block text-sm font-semibold text-slate-700">メールアドレス</label>
            <input 
              type="email" 
              name="email" 
          ...
          {/* パスワード */}
          <div>
            <label className="mb-2 block text-sm font-semibold text-slate-700">新しいパスワード</label>
            <input 
              type="password" 
              name="password" 
              placeholder="••••••••"
